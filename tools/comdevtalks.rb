...
def get_talks_submitters()
  ...
  talks = {
    ...
    "Committed_To_The_Apache_Way" => {
      ...
      "submitter" => "sharan",
      "speakers" => ["sharan"],
      "abstract" => "'To be committed' is a strange phrase. In the past it was used to describe people who were sent to mental institutions or 'facilities'. Fast forward to today and words like committed and commitment are used throughout the Open Source world. Are we all a little crazy? - Perhaps!\n\nIn this presentation Sharan shares her thoughts and experiences about being a Committer, life at the ASF (facility) and how not being able to code is still OK.\n",
      "audience" => "Community managers, developers, project managers involved with FOSS projects.",
  ...
  submitters = {
    "curcuru" => {
      ...
      "facebook" => nil,
      "bio" => "Shane has been involved at the Apache Software Foundation (ASF) since 1999, and serves as Director and VP of Brand Management, setting trademark policies and helping all 200+ Apache projects implement and defend their brands.\n\nOtherwise, Shane is: a father and husband, a friend, a geek, a Member of the ASF, a baker, and a punny guy.  Oh, and we have cats.  Shane blogs at http://communityovercode.com/ and regularly speaks on FOSS governance and branding topics.\n"},
    ...
    "sblackmon" => {
      ...
      "facebook" => nil,
      "bio" => "VP Technology at People Pattern, previously Director of Data Science at W2O Group, co-founder of Ravel, stints at Boeing, Lockheed Martin, and Accenture. Committer and PMC for Apache Streams (incubating). Experienced user of Spark, Storm, Hadoop, Pig, Hive, Nutch, Cassandra, Tinkerpop, and more.\n"
    },
    "sharan" => {
      "name" => "Sharan Foga",
      "website" => nil,
      "twitter" => nil,
      "facebook" => nil,
      "bio" => "Sharan Foga have been involved with the ASF since 2008 and has presented at previous Apachecons (Vancouver 2016, Budapest 2015 & 2014). She enjoys working on community management and related areas and is a Committer and PMC Member for Apache OFBiz and Community Development.\n"
    },
    "wang" => {
      "name" => "Andrew Wang",
