...
def emit_form(apacheid, mdata, button_help, uimap)
  ...
  _whimsy_panel("#{title} (#{apacheid})", style: 'panel-success') do
    _form.form_horizontal method: 'post' do
      ...
      _whimsy_forms_checkradio(label: "LAbel for checkbox", name: "check1", 
        type: 'checkbox', options: ['one - cat to fule em all', 'three bottles of beer on the warll', 'five fingered toes'],
        selected: ['one - cat to fule em all', 'argh', 'five fingered toes'],
        helptext: "This is all my helptext"
      )
      _whimsy_forms_checkradio(label: "LAbel for radidio", name: "rad1", 
        type: 'radio', options: {two: 'two is edden', three: 'three is cartoon', five: 'five-oh'}, selected: 'three',
        helptext: "This is not my helptext"
      )
