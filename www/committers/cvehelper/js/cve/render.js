...
pug_mixins["mitrelegacy"] = pug_interp = function(cve){
var block = (this && this.block), attributes = (this && this.attributes) || {};
var CDM = cve.CVE_data_meta;
pug_html = pug_html + ("\u003Cp\u003E" + (pug_escape(null == (pug_interp = "Go to https://cveform.mitre.org/ and use 'Notify CVE about a publication'. You must use your @apache.org e-mail address in the form. Fill in the two required fields and put the following formatted details in the field labelled 'Additional information and CVE ID description updates':") ? "" : pug_interp)) + "\u003C\u002Fp\u003E" + (pug_escape(null == (pug_interp = "[CVEID]:"+CDM.ID) ? "" : pug_interp)) + "\u003Cbr\u002F\u003E" + (pug_escape(null == (pug_interp = "[PRODUCT]:"+textUtil.getProductListNoVendor(cve)) ? "" : pug_interp)) + "\u003Cbr\u002F\u003E" + (pug_escape(null == (pug_interp = "[VERSION]:"+textUtil.getAffectedProductString(cve).split(':',2)[1]) ? "" : pug_interp)) + "\u003Cbr\u002F\u003E" + (pug_escape(null == (pug_interp = "[PROBLEMTYPE]:") ? "" : pug_interp)) + "\u003Cbr\u002F\u003E" + (pug_escape(null == (pug_interp = "[REFERENCES]:") ? "" : pug_interp)));
// iterate cve.references.reference_data
;(function(){
  var $$obj = cve.references.reference_data;
  if ('number' == typeof $$obj.length) {
...
pug_html = pug_html + ((pug_escape(null == (pug_interp = r.url) ? "" : pug_interp)) + (pug_escape(null == (pug_interp = ' ') ? "" : pug_interp)));
      }
  } else {
    var $$l = 0;
...
pug_html = pug_html + ("\u003Cbr\u002F\u003E" + (pug_escape(null == (pug_interp = "[DESCRIPTION]:") ? "" : pug_interp)));
// iterate cve.description.description_data
;(function(){
  var $$obj = cve.description.description_data;
  if ('number' == typeof $$obj.length) {
...
if ((cve.solution && cve.solution.length > 0) || (cve.source.defect && cve.source.defect.length > 0)) {
...
if ((cve.work_around && cve.work_around > 0)) {
...
pug_html = pug_html + "\u003C\u002Ful\u003E";
if (((cve.impact && cve.impact.cvss)||(cve.credit && cve.credit.length))) {
pug_html = pug_html + "\u003Ch4\u003ECVSS SCORE:\u003C\u002Fh4\u003E";
}
if (cve.impact && cve.impact.cvss) {
pug_html = pug_html + "\u003Cp\u003E";
pug_mixins["CVSS"](cve.impact.cvss);
...
var block = (this && this.block), attributes = (this && this.attributes) || {};
var CDM = cve.CVE_data_meta;
pug_html = pug_html + ((pug_escape(null == (pug_interp = "To: oss-security@lists.openwall.com") ? "" : pug_interp)) + "\u003Cbr\u002F\u003E" + (pug_escape(null == (pug_interp = "From: " + cve.CVE_data_meta.EMAIL) ? "" : pug_interp)) + "\u003Cbr\u002F\u003E" + (pug_escape(null == (pug_interp = "Reply-to: **yourusermailinglist**@**project**.apache.org") ? "" : pug_interp)) + "\u003Cbr\u002F\u003E" + (pug_escape(null == (pug_interp = "Subject: ") ? "" : pug_interp)));
if (cve.source.advisory) {
pug_html = pug_html + (pug_escape(null == (pug_interp = cve.source.advisory +": ") ? "" : pug_interp));
}
pug_html = pug_html + (pug_escape(null == (pug_interp = cve.CVE_data_meta.ID +": ") ? "" : pug_interp));
if (cve.CVE_data_meta.TITLE) {
pug_html = pug_html + (pug_escape(null == (pug_interp = cve.CVE_data_meta.TITLE +" ") ? "" : pug_interp));
}
else {
pug_html = pug_html + (pug_escape(null == (pug_interp = textUtil.getProductListNoVendor(cve) + " ") ? "" : pug_interp));
...
pug_html = pug_html + "\u003Cbr\u002F\u003E\u003Cbr\u002F\u003E" + (pug_escape(null == (pug_interp = "Description:") ? "" : pug_interp)) + "\u003Cbr\u002F\u003E\u003Cbr\u002F\u003E";
// iterate cve.description.description_data
;(function(){
  var $$obj = cve.description.description_data;
  if ('number' == typeof $$obj.length) {
...
pug_html = pug_html + "\u003Cbr\u002F\u003E\u003Cbr\u002F\u003E" + (pug_escape(null == (pug_interp = textUtil.getAffectedProductString(cve)) ? "" : pug_interp)) + "\u003Cbr\u002F\u003E\u003Cbr\u002F\u003E";
// iterate cve.credit
;(function(){
  var $$obj = cve.credit;
  if ('number' == typeof $$obj.length) {
...
pug_html = pug_html + (pug_escape(null == (pug_interp = c.value) ? "" : pug_interp)) + "\u003Cbr\u002F\u003E\u003Cbr\u002F\u003E";
}
      }
  } else {
    var $$l = 0;
